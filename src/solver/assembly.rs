...
impl HydraulicSolver {
  ...
  pub fn assemble_jacobian(&self, network: &Network, state: &mut SolverState, values: &mut Vec<f64>, rhs: &mut Vec<f64>, link_coefficients: &mut ResistanceCoefficients, excess_flows: &Vec<f64>, grounded_nodes: &[bool]) {
  ...
  fn link_contributions(&self, network: &Network, state: &mut SolverState, values: &mut Vec<f64>, rhs: &mut Vec<f64>, link_coefficients: &mut ResistanceCoefficients, excess_flows: &Vec<f64>) {
  ...
  fn emitter_contributions(&self, network: &Network, state: &mut SolverState, values: &mut Vec<f64>, rhs: &mut Vec<f64>) {
  ...
  fn demand_contributions(&self, network: &Network, state: &mut SolverState, values: &mut Vec<f64>, rhs: &mut Vec<f64>) {
